      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            ...
            InkWell(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => History(history: history,)));
                },
                ...
                Expanded(
                  ...
                  child: InkWell(
                    onTap: ()async{
                      ...
                      if (result.isSuccess) {
                        history.add(TextController.text+" = "+result.value.toString());
                        sharedPref.save("history", history);
                        // setState(() {
                ...
                Expanded(
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                        ...
                        child: Center(child: Text('Clear',style: TextStyle(fontSize: 20),))),
                  ),
                ),
              ],
            ),
          ],
        ):Center(child: CircularProgressIndicator(),), //<- place where the image appears
      ),
    );
  }
}
